...
public class MainActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        initiated = settings.getBoolean("initiated", false);

        // Remembers that the app is initiated and disable and hide the database
        if(!initiated){
            Initiate();
        }
    }
    ...
    public void onClick(View v)
    {
        ...
        if(id == R.id.btn_viewList && initiated == true){
            ...
            Intent inAbout = new Intent(v.getContext(), AboutActivity.class);
    ...
    protected void onStop(){
        ...
        editor.putBoolean("initiated", initiated);
