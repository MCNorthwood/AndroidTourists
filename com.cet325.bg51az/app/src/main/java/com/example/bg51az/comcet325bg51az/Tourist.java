...
public class Tourist {
    ...
    public void setFavourite(boolean pFavourite){favourite = pFavourite;}
    public void setPlanned(String pPlanned){planned = pPlanned;}
    public void setVisited(String pVisited){visited = pVisited;}
    public void setImage(String pImage){image = pImage;}
    public void setGeolocation(String pGeolocation){geolocation = pGeolocation;}
    public void setPrice(double pPrice){price = pPrice;}
    public void setRank(int pRank){rank = pRank;}
